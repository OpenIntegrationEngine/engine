...
public class BrandingConstants {
    ...
    public static final String HELP_DEFAULT_LOCATION = "https://github.com/openintegrationengine";
    ...
    public static final String MIRTHCORP_URL = "https://github.com/openintegrationengine";
    public static final String MIRTHCORP_TOOLTIP = "OpenInterationEngine";


    // The URL that is opened when clicking the image in the Top right corner of the main administrator window
    public static final String MIRTHCONNECT_URL = "https://github.com/openintegrationengine";
    public static final String MIRTHCONNECT_TOOLTIP = "OpenIntegrationEngine";

    // TODO Don't know
    public static String HELP_URL_LOCATION = "https://nonexi.stant";
